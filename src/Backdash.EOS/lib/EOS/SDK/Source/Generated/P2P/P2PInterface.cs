...
namespace Epic.OnlineServices.P2P
{
	public sealed partial class P2PInterface : Handle
	{
		...
		/// <see cref="Result.NotFound" /> - If there are no packets available for the requesting user
		/// </returns>
		public unsafe Result ReceivePacket(ref ReceivePacketOptions options, out ProductUserId outPeerId, out SocketId outSocketId, out byte outChannel, System.Span<byte> outData, out uint outBytesWritten)
		{
			...
			Result funcResult;
			fixed (void* outDataPtr = outData)
			{
				funcResult = Bindings.EOS_P2P_ReceivePacket(InnerHandle, ref optionsInternal, ref outPeerIdAddress, ref outSocketIdInternal, ref outChannel, (nint) outDataPtr, ref outBytesWritten);
			}
