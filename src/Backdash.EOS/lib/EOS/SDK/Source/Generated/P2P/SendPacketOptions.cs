...
namespace Epic.OnlineServices.P2P
{
	...
	public struct SendPacketOptions
	{
		...
		/// <summary>
		/// Pointer to the data to be sent to the RemoteUser
		/// </summary>
		...
		/// Pointer to the data to be sent to the RemoteUser
		/// </summary>
		public uint DataLengthInBytes { get; set; }
	...
	internal struct SendPacketOptionsInternal : ISettable<SendPacketOptions>, System.IDisposable
	{
		...
		public void Set(ref SendPacketOptions other)
		{
			...
			Data = other.Data;
			DataLengthInBytes = other.DataLengthInBytes;
		...
		public void Set(ref SendPacketOptions? other)
		{
			if (other.HasValue)
			{
				...
				DataLengthInBytes = other.Value.DataLengthInBytes;
